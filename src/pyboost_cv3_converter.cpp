...
Mat fromNDArrayToMat(PyObject* o) {
	...
	if (!PyArray_Check(o)) {
		...
		// if(type == CV_8U){
		// 	std::cout<<"type: CV_8U"<<std::endl;
		// }else if(type == CV_8S){
		// 	std::cout<<"type: CV_8S"<<std::endl;
		// }else if(type == CV_16U){
		// 	std::cout<<"type: CV_16U"<<std::endl;
		// }else if(type == CV_16S){
		// 	std::cout<<"type: CV_16S"<<std::endl;
		// }else if(type == CV_32S){
		// 	std::cout<<"type: CV_32S"<<std::endl;
		// }else if(type == CV_32S){
		// 	std::cout<<"type: CV_32S"<<std::endl;
		// }else if(type == CV_32F){
		// 	std::cout<<"type: CV_32F"<<std::endl;
		// }else if(type == CV_64F){
		// 	std::cout<<"type: CV_64F"<<std::endl;
		// }
